!(function (t) {
  ...
  function s(t, e, r) {
    ...
    for (
      (function t(e, r, s, a) {
          ...
          for (u = 0; u < s.length; u++)
            if (s[u] === e) {
              ...
              return void (void 0 !== c.get
                ? c.configurable
                  ? (Object.defineProperty(a, r, { value: "[Circular]" }),
                    n.push([a, r, e, c]))
                  : i.push([e, r])
                : ((a[r] = "[Circular]"), n.push([a, r, e])));
            }
        ...
        s = 0 === i.length ? JSON.stringify(t, e, r) : JSON.stringify(t, c(e), r);
        0 !== n.length;
    ) {
      var a = n.pop();
      4 === a.length
  ...
  function u(t, e, r) {
            ...
            for (c = 0; c < s.length; c++)
              if (s[c] === e) {
                ...
                return void (void 0 !== l.get
                  ? l.configurable
                    ? (Object.defineProperty(u, r, { value: "[Circular]" }),
                      n.push([u, r, e, l]))
                    : i.push([e, r])
                  : ((u[r] = "[Circular]"), n.push([u, r, e])));
              }
    ...
    for (
      s = 0 === i.length ? JSON.stringify(u, e, r) : JSON.stringify(u, c(e), r);
      0 !== n.length;
  ...
  var p = Object.prototype.hasOwnProperty,
    ...
    y = {
      ...
      compact: function (t) {
        for (
          ...
          for (
            var n = e[o], i = n.obj[n.prop], s = Object.keys(i), a = 0;
            a < s.length;
            ++a
          ) {
            var u = s[a],
        ...
        for (var n = "", i = 0; i < o.length; ++i) {
          ...
          (s >= 97 && s <= 122)
            ...
            ? (n +=
                ...
                h[128 | (63 & s)])
            : ((i += 1),
              (s = 65536 + (((1023 & s) << 10) | (1023 & o.charCodeAt(i)))),
              (n +=
                h[240 | (s >> 18)] +
                h[128 | ((s >> 12) & 63)] +
                h[128 | ((s >> 6) & 63)] +
    ...
    m = /%20/g,
    b = { RFC1738: "RFC1738", RFC3986: "RFC3986" },
    v = y.assign(
      {
        default: b.RFC3986,
        formatters: {
  ...
  var w = Object.prototype.hasOwnProperty,
    ...
    k = function t(e, r, o, n, i, s, a, u, c, l, p, f, h) {
      ...
      if (
        ...
        return s
          ? [
              p(f ? r : s(r, x.encoder, h, "key")) +
                "=" +
                p(s(m, x.encoder, h, "value")),
            ]
          : [p(r) + "=" + p(String(m))];
      var b,
        v = [];
      ...
      Array.isArray,
      {
        stringify: function (t, e) {
                  ...
                  (n = t.filter),
                {
                  addQueryPrefix:
                    "boolean" == typeof t.addQueryPrefix
                      ...
                      : x.addQueryPrefix,
                  allowDots:
                    void 0 === t.allowDots ? x.allowDots : !!t.allowDots,
                  charset: e,
                  charsetSentinel:
                  ...
                  encoder:
                    "function" == typeof t.encoder ? t.encoder : x.encoder,
                  encodeValuesOnly:
          ...
          "function" == typeof n.filter
            ? (o = (0, n.filter)("", o))
            : T(n.filter) && (r = n.filter);
          var i,
            s = [];
          if ("object" != _(o) || null === o) return "";
          i =
            e && e.arrayFormat in g
              ? e.arrayFormat
              : e && "indices" in e
              ? e.indices
                ? "indices"
    ...
    if (t)
      return (function (t) {
        for (var e in q.prototype)
          Object.prototype.hasOwnProperty.call(q.prototype, e) &&
            (t[e] = q.prototype[e]);
        return t;
      })(t);
  }
  (P = q),
    (q.prototype.clearTimeout = function () {
      return (
  ...
  (q.prototype._shouldRetry = function (t, e) {
    ...
    (q.prototype.getHeader = q.prototype.get),
    ...
    (q.prototype.field = function (t, e) {
      ...
      if (Array.isArray(e)) {
        for (var o in e)
          Object.prototype.hasOwnProperty.call(e, o) && this.field(t, e[o]);
        return this;
      }
    ...
    (q.prototype.send = function (t) {
      ...
      if (e && R(this._data))
        for (var o in t)
          Object.prototype.hasOwnProperty.call(t, o) && (this._data[o] = t[o]);
      else
        "string" == typeof t
          ? (r || this.type("form"),
  ...
  function M(t) {
    if (t)
      return (function (t) {
        for (var e in M.prototype)
          Object.prototype.hasOwnProperty.call(M.prototype, e) &&
            (t[e] = M.prototype[e]);
        return t;
      })(t);
  }
  ...
  (J.Request = ot),
    (K.getXHR = function () {
      if (
        $.XMLHttpRequest &&
        (!$.location || "file:" !== $.location.protocol || !$.ActiveXObject)
      )
  ...
  function Y(t) {
    ...
    var e = [];
    for (var r in t)
      Object.prototype.hasOwnProperty.call(t, r) && Z(e, r, t[r]);
    return e.join("&");
  }
  function Z(t, e, r) {
    if (void 0 !== r)
  ...
  function rt(t) {
    ...
    1223 === e && (e = 204),
      ...
      this.xhr.getResponseHeader("X-Additional-Info") &&
        K.get(this.xhr.getResponseHeader("X-Additional-Info")).then(
          (result) => {
  ...
  return (
    ...
    z(rt.prototype),
    (rt.prototype._parseBody = function (t) {
      var e = K.parse[this.type];
      return this.req._parser
        ? this.req._parser(this, t)
        : (!e && et(this.type) && (e = K.parse["application/json"]),
    ...
    (ot.prototype._getFormData = function () {
      return (
        this._formData || (this._formData = new $.FormData()), this._formData
      );
    }),
    ...
    (ot.prototype.ca = ot.prototype.agent),
    (ot.prototype.buffer = ot.prototype.ca),
    (ot.prototype.write = function () {
      throw new Error(
        "Streaming is not supported in browser version of superagent"
      );
    }),
    (ot.prototype.pipe = ot.prototype.write),
    (ot.prototype._isHost = function (t) {
      return (
        t &&
        "object" == G(t) &&
        !Array.isArray(t) &&
